...
function BackToTopCom({ cls, whatsappNumber }) {
  useEffect(() => {
  ...
  const href = whatsappNumber
    ? `${WHATSAPP_URL}${whatsappNumber.replace(/\D/g, "")}`
    : "https://chat.whatsapp.com/KZNgF0snHw5DwTdODVk8oH";
  ...
  return (
    <div className={`back-to-top-wrapper ${cls || ""}`}>
      <a
        ...
        className="back-to-top-btn back-to-top-btn--whatsapp"
