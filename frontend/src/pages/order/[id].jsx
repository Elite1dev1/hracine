                      ...
                      <div className="row align-items-end">
                        <div className="col-md-4 col-sm-6">
                          <div className="invoice__left">
                            <Image src={logo} alt="logo" width={120} height={120} style={{ width: 'auto', height: 'auto', maxWidth: '150px', marginBottom: '10px' }} />
                  ...
                  <tbody className="table-group-divider">
                    {cart.map((item, i) => (
                      <tr key={i}>
                        ...
                        <td>{formatCurrency(item.price * item.orderQuantity)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-3 col-md-4">
                    <div className="invoice__shippint-cost mb-30">
                      ...
                      <p className="tp-font-medium">{formatCurrency(shippingCost)}</p>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-4">
                    <div className="invoice__discount-cost mb-30">
                      <h5 className="mb-0">Discount</h5>
                      <p className="tp-font-medium">{formatCurrency(discount)}</p>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-4">
                    <div className="invoice__total-ammount mb-30">
                      ...
                      <p className="tp-font-medium text-danger">
                        <strong>{formatCurrency(parseInt(totalAmount))}</strong>
                      </p>
                    </div>
                  </div>
                </div>
