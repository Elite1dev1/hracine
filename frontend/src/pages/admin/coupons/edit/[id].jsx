...
const EditCouponPage = () => {
  ...
  const { data: couponData, isLoading: isLoadingCoupon } = useAdminGetCouponByIdQuery(id, {
    skip: !id,
  });
  const [updateCoupon, { isLoading }] = useAdminUpdateCouponMutation();
  ...
  useEffect(() => {
    if (couponData) {
      ...
      setFormData({
        ...
        productType: coupon.productType || 'electronics',
  ...
  return (
    <AdminLayout>
      <div>
        <h1 style={{ marginBottom: '30px', color: '#2c3e50' }}>Edit Coupon</h1>
